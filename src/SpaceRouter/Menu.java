...
public class Menu{
    ...
    static Media intro_source = new Media(new File("src/Audio/centys-week-4749.mp3").toURI().toString());
    static MediaPlayer intro = new MediaPlayer(intro_source);

    public Menu() throws FileNotFoundException {

        //Font for all text in the game
        Font myfont = Font.loadFont(new FileInputStream(new File("src/Font/ARCADECLASSIC.TTF")), 60);
    ...
    public void MainMenu() throws Exception{
        ...
        FileInputStream input = new FileInputStream("src/images/spacedribbble.gif");
        ...
        FileInputStream input1 = new FileInputStream("src/images/SPACE-ROUTER.png");
    ...
    //@Override
    //public void start(Stage window) throws Exception{MainMenu();}
