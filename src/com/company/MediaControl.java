...
public class MediaControl extends BorderPane {
   ...
   // private final Slider timeSlider;
    ...
    public MediaControl(Stage openingStage, final MediaPlayer mp) {
        this.mp = mp;
...
// Add Time label
        ...
        mediaBar.getChildren().addAll(timeLabel,skip);
skip.setOnAction(e->{
    mp.stop();
    Instructions MediaBar = new Instructions();
    MediaBar.levelInstruction(openingStage);
...
//        });
    ...
    protected void updateValues() {
        if (playTime != null  && volumeSlider != null) {
            Platform.runLater(() -> {
...
public void instructionStage(Stage openingStage){
        Button button1= new Button();
        Button button2= new Button();
        Button button3= new Button();
        Button button4= new Button();
    VBox insButtonbox = new VBox(button1, button2, button3);
    ...
    insRootnode.setBottom(button4);

    Scene insScene = new Scene(insRootnode, 400, 400);
